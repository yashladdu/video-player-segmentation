...
const Video = () => {
  ...
  const chapters = currentVideo?.chapters || []; // Ensure it's always an array
    ...
    <Container p={2} sx={{display: "flex", justifyContent: "center", marginTop: "10px"}}>
      <Card bgcolor={"background.default"} color={"text.primary"} sx={{width: "920px"}}>
        ...
        <CardHeader
          ...
          title={channel.name}
          subheader={currentVideo ? currentVideo.createdAt : "Loading..."} 
        />
        <CardContent>
          <Typography variant="h5" >
           {currentVideo ? currentVideo.title : "Loading..."}
          </Typography> 
        </CardContent>
        ...
        <Collapse in={expanded} timeout="auto" unmountOnExit>
          <CardContent>
            ...
            <Typography paragraph>
              {currentVideo ? currentVideo.description : "Loading..."}
            </Typography>       
          </CardContent>
        </Collapse>
